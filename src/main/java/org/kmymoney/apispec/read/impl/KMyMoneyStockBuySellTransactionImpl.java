 ...
 */
public class KMyMoneyStockBuySellTransactionImpl extends KMyMoneyTransactionImpl
										         implements KMyMoneyStockBuySellTransaction
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(KMyMoneyStockBuySellTransactionImpl.class);
	...
	public KMyMoneyStockBuySellTransactionImpl(final KMyMoneyTransactionImpl trx) {
		super(trx);
