 ...
 */
public class KMyMoneyStockDividendTransactionImpl extends KMyMoneyTransactionImpl
										          implements KMyMoneyStockDividendTransaction
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(KMyMoneyStockDividendTransactionImpl.class);
	...
	public KMyMoneyStockDividendTransactionImpl(KMyMoneyTransactionImpl trx) {
		super(trx);
	...
	private void addIncomeAcctSplit(final KMyMoneyTransactionSplitImpl splt) throws TransactionValidationException {
	...
	public String toString() {
		...
		buffer.append("KMyMoneyStockDividendTransactionImpl [");
