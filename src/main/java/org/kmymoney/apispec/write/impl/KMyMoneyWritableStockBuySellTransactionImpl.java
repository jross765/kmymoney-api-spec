...
import org.kmymoney.apispec.read.KMyMoneyStockBuySellTransaction;
import org.kmymoney.apispec.read.impl.KMyMoneySimpleTransactionImpl;
import org.kmymoney.apispec.read.impl.KMyMoneyStockBuySellTransactionImpl.SplitAccountType;
 ...
 */
public class KMyMoneyWritableStockBuySellTransactionImpl extends KMyMoneyWritableTransactionImpl 
                                                         implements KMyMoneyWritableStockBuySellTransaction
{
	private static final Logger LOGGER = LoggerFactory.getLogger(KMyMoneyWritableStockBuySellTransaction.class);
     ...
     */
    public KMyMoneyWritableStockBuySellTransactionImpl(final KMyMoneyStockBuyTransactionImpl trx) {
    	super(trx);
		...
		try {
			...
			throw new IllegalArgumentException("argument <trx> does not meet the criteria for a stock-buy-sell transaction");
		} catch ( Exception exc ) {
     ...
     * @param trx the file we belong to
     */
    public KMyMoneyWritableStockBuySellTransactionImpl(final KMyMoneyWritableStockBuySellTransaction trx) {
    	super(trx);
    ...
    public KMyMoneyWritableStockBuySellTransactionImpl(final KMyMoneyStockBuySellTransaction trx) {
    	super(trx);
	...
	protected void validateStockAcctSplit(final KMyMoneyTransactionSplit splt) throws TransactionValidationException {
		...
		// Sic: Here, both positive and negative values are OK.
		// But not zero.
