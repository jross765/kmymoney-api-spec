 ...
 */
public class KMyMoneyWritableStockBuyTransactionImpl extends KMyMoneyWritableStockBuySellTransactionImpl 
                                                     implements KMyMoneyWritableStockBuyTransaction
{

	private static final Logger LOGGER = LoggerFactory.getLogger(KMyMoneyWritableStockBuyTransactionImpl.class);
...
//		}
	...
	public KMyMoneyWritableStockBuyTransactionImpl(final KMyMoneyWritableStockBuySellTransactionImpl trx) {
		super(trx);
